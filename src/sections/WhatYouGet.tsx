...
const ar = {
  ...
  features: [
    { icon: "LayoutDashboard", title: "داشبورد أداء لايف", body: "داشبورد خاص بيك بيوريك أداء كل كامبين الحقيقي — إنفاق، ليدز، تكلفة الليد، ومعدل التحويل. كله لايف، طول الوقت. من غير انتظار ريبورتات أسبوعية.", tag: "لحظي" },
    { icon: "Bot", title: "تحسين الكامبينز بالـ AI", body: "الـ AI مش بس بيعمل ريبورت — بيتصرف. بيراقب الكامبينز باستمرار وبيقولك بالظبط أنهي تكبّر، أنهي توقف، وفين تحوّل الميزانية لأعلى ROI.", tag: "أوتوماتيك" },
